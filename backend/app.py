...
async def chat_completion(request: ChatRequest):
    ...
    # Define preprompt
    preprompt = "Kamu adalah seorang chatbot yang ditugaskan untuk menjawab pertanyaan seputar Islam dan Al-Quran. tolong hanya jawab sesuai konteks yang diberikan"
